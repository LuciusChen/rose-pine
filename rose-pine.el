  ...
  (quote
   (mapcar
    ...
    `(;; Standard font lock faces
      ...
      (mode-line-inactive (:inherit mode-line :foreground ,comment :background ,highlight :weight normal :box (:line-width 1 :color ,comment)))
      ...
      (org-habit-overdue-face (:foreground ,background :background ,pine))
