  ...
  (quote
   (mapcar
    ...
    `(;; Standard font lock faces
      ...
      ;; Outline (built-in)
      (outline-1 (:inherit nil :foreground ,pine :weight bold))
      (outline-2 (:inherit nil :foreground ,iris  :weight bold))
      (outline-3 (:inherit nil :foreground ,foam  :weight bold))
      (outline-4 (:inherit nil :foreground ,love  :weight bold))
      (outline-5 (:inherit nil :foreground ,gold  :weight bold))
      (outline-6 (:inherit nil :foreground ,pine  :weight bold))
      (outline-7 (:inherit nil :foreground ,iris  :weight bold))
      (outline-8 (:inherit nil :foreground ,foam  :weight bold))
      (outline-9 (:inherit nil :foreground ,love  :weight bold))
